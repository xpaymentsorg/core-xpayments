...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db xpsdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db xpsdb.Database) error {
