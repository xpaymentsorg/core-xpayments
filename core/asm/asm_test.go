...
// Tests disassembling the instructions for valid xvm code
...
// Tests disassembling the instructions for invalid xvm code
...
// Tests disassembling the instructions for empty xvm code
