...
// NewXVMBlockContext creates a new context for use in the XVM.
func NewXVMBlockContext(header *types.Header, chain ChainContext, author *common.Address) vm.BlockContext {
	var (
...
// NewXVMTxContext creates a new transaction context for a single transaction.
func NewXVMTxContext(msg Message) vm.TxContext {
	return vm.TxContext{
		Origin:   msg.From(),
