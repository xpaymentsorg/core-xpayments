...
// Contains a wrapper for the xPayments client.
...
// xPaymentsClient provides access to the xPayments APIs.
type xPaymentsClient struct {
	client *xpsclient.Client
}

// NewxPaymentsClient connects a client to the given URL.
func NewxPaymentsClient(rawurl string) (client *xPaymentsClient, _ error) {
	rawClient, err := xpsclient.Dial(rawurl)
	return &xPaymentsClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *xPaymentsClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *xPaymentsClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *xPaymentsClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *xPaymentsClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *xPaymentsClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *xPaymentsClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *xPaymentsClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *xPaymentsClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *xPaymentsClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *xPaymentsClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *xPaymentsClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *xPaymentsClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *xPaymentsClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *xPaymentsClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *xPaymentsClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *xPaymentsClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *xPaymentsClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *xPaymentsClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *xPaymentsClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *xPaymentsClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *xPaymentsClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *xPaymentsClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *xPaymentsClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *xPaymentsClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *xPaymentsClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *xPaymentsClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *xPaymentsClient) SendTransaction(ctx *Context, tx *Transaction) error {
