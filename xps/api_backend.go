...
func (b *XpsAPIBackend) GetXVM(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header, vmConfig *vm.Config) (*vm.XVM, func() error, error) {
	...
	return vm.NewXVM(context, txContext, state, b.xps.blockchain.Config(), *vmConfig), vmError, nil
}
...
func (b *XpsAPIBackend) RPCXVMTimeout() time.Duration {
