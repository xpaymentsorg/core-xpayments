...
// Peer is a collection of relevant information we have about a `xps` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `xps` protocol version.
...
// ReplyPooledTransactionsRLP is the xps/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the xps/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the xps/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the xps/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the xps/66 response to GetReceipts.
