...
// TestXps66EmptyMessages tests encoding of empty xps66 messages
func TestXps66EmptyMessages(t *testing.T) {
...
// TestXps66Messages tests the encoding of all redefined xps66 messages
func TestXps66Messages(t *testing.T) {
