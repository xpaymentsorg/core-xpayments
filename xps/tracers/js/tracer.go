...
import (
	...
	tracers2 "github.com/xpaymentsorg/go-xpayments/xps/tracers"
	"github.com/xpaymentsorg/go-xpayments/xps/tracers/js/internal/tracers"
...
// init retrieves the JavaScript transaction tracers included in go-xpayments.
func init() {
...
type jsTracer struct {
	...
	env *vm.XVM          // XVM instance executing the code being traced
...
func (jst *jsTracer) CaptureStart(env *vm.XVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	jst.env = env
	jst.ctx["type"] = "CALL"
	if create {
		jst.ctx["type"] = "CREATE"
