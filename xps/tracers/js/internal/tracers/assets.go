...
func xvmdis_tracerJs() (*asset, error) {
	bytes, err := xvmdis_tracerJsBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "xvmdis_tracer.js", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	...
	"xvmdis_tracer.js":          xvmdis_tracerJs,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"xvmdis_tracer.js":          {xvmdis_tracerJs, map[string]*bintree{}},
