...
// NewJSONLogger creates a new XVM tracer that prints execution steps as JSON objects
...
func (l *JSONLogger) CaptureStart(env *vm.XVM, from, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	l.env = env
}
