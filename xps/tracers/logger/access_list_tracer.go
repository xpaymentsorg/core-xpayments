...
// accessList is an accumulator for the set of accounts and storage slots an XVM
// contract execution touches.
type accessList map[common.Address]accessListSlots

// accessListSlots is an accumulator for the set of storage slots within a single
// contract that an XVM contract execution touches.
...
func (a *AccessListTracer) CaptureStart(env *vm.XVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
}
