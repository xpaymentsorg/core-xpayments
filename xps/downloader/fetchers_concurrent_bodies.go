...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *xps.Response) (*xps.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *xps.Response) (int, error) {
	txs, uncles := packet.Res.(*xps.BlockBodiesPacket).Unpack()
