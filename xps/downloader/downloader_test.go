...
func newTester() *downloadTester {
	...
	chain, err := core.NewBlockChain(db, nil, params.TestChainConfig, xpsash.NewFaker(), vm.Config{}, nil, nil)
	if err != nil {
		panic(err)
	}
...
func (dlp *downloadTesterPeer) RequestHeadersByHash(origin common.Hash, amount int, skip int, reverse bool, sink chan *xps.Response) (*xps.Request, error) {
	// Service the header query via the live handler code
	rlpHeaders := xps.ServiceGetBlockHeadersQuery(dlp.chain, &xps.GetBlockHeadersPacket{
	...
	res := &xps.Response{
		Req:  req,
		Res:  (*xps.BlockHeadersPacket)(&headers),
		Meta: hashes,
		Time: 1,
...
// origin; associated with a particular peer in the download tester. The returned
// function can be used to retrieve batches of headers from the particular peer.
func (dlp *downloadTesterPeer) RequestHeadersByNumber(origin uint64, amount int, skip int, reverse bool, sink chan *xps.Response) (*xps.Request, error) {
	// Service the header query via the live handler code
	rlpHeaders := xps.ServiceGetBlockHeadersQuery(dlp.chain, &xps.GetBlockHeadersPacket{
		Origin: xps.HashOrNumber{
			Number: origin,
...
func (dlp *downloadTesterPeer) RequestBodies(hashes []common.Hash, sink chan *xps.Response) (*xps.Request, error) {
	blobs := xps.ServiceGetBlockBodiesQuery(dlp.chain, hashes)

	bodies := make([]*xps.BlockBody, len(blobs))
	for i, blob := range blobs {
		bodies[i] = new(xps.BlockBody)
	...
	res := &xps.Response{
		Req:  req,
		Res:  (*xps.BlockBodiesPacket)(&bodies),
...
func (dlp *downloadTesterPeer) RequestReceipts(hashes []common.Hash, sink chan *xps.Response) (*xps.Request, error) {
	blobs := xps.ServiceGetReceiptsQuery(dlp.chain, hashes)
	...
	res := &xps.Response{
		Req:  req,
		Res:  (*xps.ReceiptsPacket)(&receipts),
		Meta: hashes,
		Time: 1,
		Done: make(chan error, 1), // Ignore the returned status
	}
...
func TestCanonicalSynchronisation66Full(t *testing.T)  { testCanonSync(t, xps.XPS66, FullSync) }
func TestCanonicalSynchronisation66Snap(t *testing.T)  { testCanonSync(t, xps.XPS66, SnapSync) }
func TestCanonicalSynchronisation66Light(t *testing.T) { testCanonSync(t, xps.XPS66, LightSync) }
...
func TestThrottling66Full(t *testing.T) { testThrottling(t, xps.XPS66, FullSync) }
func TestThrottling66Snap(t *testing.T) { testThrottling(t, xps.XPS66, SnapSync) }
...
func TestForkedSync66Full(t *testing.T)  { testForkedSync(t, xps.XPS66, FullSync) }
func TestForkedSync66Snap(t *testing.T)  { testForkedSync(t, xps.XPS66, SnapSync) }
func TestForkedSync66Light(t *testing.T) { testForkedSync(t, xps.XPS66, LightSync) }
...
func TestHeavyForkedSync66Full(t *testing.T)  { testHeavyForkedSync(t, xps.XPS66, FullSync) }
func TestHeavyForkedSync66Snap(t *testing.T)  { testHeavyForkedSync(t, xps.XPS66, SnapSync) }
func TestHeavyForkedSync66Light(t *testing.T) { testHeavyForkedSync(t, xps.XPS66, LightSync) }
...
// long dead chains.
func TestBoundedForkedSync66Full(t *testing.T)  { testBoundedForkedSync(t, xps.XPS66, FullSync) }
func TestBoundedForkedSync66Snap(t *testing.T)  { testBoundedForkedSync(t, xps.XPS66, SnapSync) }
func TestBoundedForkedSync66Light(t *testing.T) { testBoundedForkedSync(t, xps.XPS66, LightSync) }
...
func TestBoundedHeavyForkedSync66Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, xps.XPS66, FullSync)
}
func TestBoundedHeavyForkedSync66Snap(t *testing.T) {
	testBoundedHeavyForkedSync(t, xps.XPS66, SnapSync)
}
func TestBoundedHeavyForkedSync66Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, xps.XPS66, LightSync)
}
...
func TestCancel66Full(t *testing.T)  { testCancel(t, xps.XPS66, FullSync) }
func TestCancel66Snap(t *testing.T)  { testCancel(t, xps.XPS66, SnapSync) }
func TestCancel66Light(t *testing.T) { testCancel(t, xps.XPS66, LightSync) }
...
func TestMultiSynchronisation66Full(t *testing.T)  { testMultiSynchronisation(t, xps.XPS66, FullSync) }
func TestMultiSynchronisation66Snap(t *testing.T)  { testMultiSynchronisation(t, xps.XPS66, SnapSync) }
func TestMultiSynchronisation66Light(t *testing.T) { testMultiSynchronisation(t, xps.XPS66, LightSync) }
...
func TestMultiProtoSynchronisation66Full(t *testing.T)  { testMultiProtoSync(t, xps.XPS66, FullSync) }
func TestMultiProtoSynchronisation66Snap(t *testing.T)  { testMultiProtoSync(t, xps.XPS66, SnapSync) }
func TestMultiProtoSynchronisation66Light(t *testing.T) { testMultiProtoSync(t, xps.XPS66, LightSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", xps.XPS66, chain.blocks[1:])
	//tester.newPeer("peer 65", xps.XPS67, chain.blocks[1:)
...
func TestEmptyShortCircuit66Full(t *testing.T)  { testEmptyShortCircuit(t, xps.XPS66, FullSync) }
func TestEmptyShortCircuit66Snap(t *testing.T)  { testEmptyShortCircuit(t, xps.XPS66, SnapSync) }
func TestEmptyShortCircuit66Light(t *testing.T) { testEmptyShortCircuit(t, xps.XPS66, LightSync) }
...
func TestMissingHeaderAttack66Full(t *testing.T)  { testMissingHeaderAttack(t, xps.XPS66, FullSync) }
func TestMissingHeaderAttack66Snap(t *testing.T)  { testMissingHeaderAttack(t, xps.XPS66, SnapSync) }
func TestMissingHeaderAttack66Light(t *testing.T) { testMissingHeaderAttack(t, xps.XPS66, LightSync) }
...
func TestShiftedHeaderAttack66Full(t *testing.T)  { testShiftedHeaderAttack(t, xps.XPS66, FullSync) }
func TestShiftedHeaderAttack66Snap(t *testing.T)  { testShiftedHeaderAttack(t, xps.XPS66, SnapSync) }
func TestShiftedHeaderAttack66Light(t *testing.T) { testShiftedHeaderAttack(t, xps.XPS66, LightSync) }
...
func TestInvalidHeaderRollback66Snap(t *testing.T) { testInvalidHeaderRollback(t, xps.XPS66, SnapSync) }
...
func TestHighTDStarvationAttack66Full(t *testing.T) {
	testHighTDStarvationAttack(t, xps.XPS66, FullSync)
}
func TestHighTDStarvationAttack66Snap(t *testing.T) {
	testHighTDStarvationAttack(t, xps.XPS66, SnapSync)
}
func TestHighTDStarvationAttack66Light(t *testing.T) {
	testHighTDStarvationAttack(t, xps.XPS66, LightSync)
}
...
func TestBlockHeaderAttackerDropping66(t *testing.T) { testBlockHeaderAttackerDropping(t, xps.XPS66) }
...
func TestSyncProgress66Full(t *testing.T)  { testSyncProgress(t, xps.XPS66, FullSync) }
func TestSyncProgress66Snap(t *testing.T)  { testSyncProgress(t, xps.XPS66, SnapSync) }
func TestSyncProgress66Light(t *testing.T) { testSyncProgress(t, xps.XPS66, LightSync) }
...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", xpayments.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", xpayments.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", xpayments.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", xpayments.SyncProgress{
		StartingBlock: uint64(len(chain.blocks)/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want xpayments.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
// revertal).
func TestForkedSyncProgress66Full(t *testing.T)  { testForkedSyncProgress(t, xps.XPS66, FullSync) }
func TestForkedSyncProgress66Snap(t *testing.T)  { testForkedSyncProgress(t, xps.XPS66, SnapSync) }
func TestForkedSyncProgress66Light(t *testing.T) { testForkedSyncProgress(t, xps.XPS66, LightSync) }
...
func testForkedSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", xpayments.SyncProgress{
...
func TestFailedSyncProgress66Full(t *testing.T)  { testFailedSyncProgress(t, xps.XPS66, FullSync) }
func TestFailedSyncProgress66Snap(t *testing.T)  { testFailedSyncProgress(t, xps.XPS66, SnapSync) }
func TestFailedSyncProgress66Light(t *testing.T) { testFailedSyncProgress(t, xps.XPS66, LightSync) }
...
func TestFakedSyncProgress66Full(t *testing.T)  { testFakedSyncProgress(t, xps.XPS66, FullSync) }
func TestFakedSyncProgress66Snap(t *testing.T)  { testFakedSyncProgress(t, xps.XPS66, SnapSync) }
func TestFakedSyncProgress66Light(t *testing.T) { testFakedSyncProgress(t, xps.XPS66, LightSync) }
...
func TestCheckpointEnforcement66Full(t *testing.T) { testCheckpointEnforcement(t, xps.XPS66, FullSync) }
func TestCheckpointEnforcement66Snap(t *testing.T) { testCheckpointEnforcement(t, xps.XPS66, SnapSync) }
func TestCheckpointEnforcement66Light(t *testing.T) {
	testCheckpointEnforcement(t, xps.XPS66, LightSync)
}
