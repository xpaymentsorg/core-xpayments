...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *xps.Response) (*xps.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *xps.Response) (int, error) {
	receipts := *packet.Res.(*xps.ReceiptsPacket)
