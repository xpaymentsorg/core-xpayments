...
type Downloader struct {
	...
	// Skeleton sync
	skeleton *skeleton // Header skeleton to backfill the chain with (xps2 mode)
...
func New(checkpoint uint64, stateDb xpsdb.Database, mux *event.TypeMux, chain BlockChain, lightchain LightChain, dropPeer peerDropFn, success func()) *Downloader {
	if lightchain == nil {
		lightchain = chain
	}
	dl := &Downloader{
