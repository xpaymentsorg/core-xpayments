...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *xps.Response) (*xps.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *xps.Response) (int, error) {
	headers := *packet.Res.(*xps.BlockHeadersPacket)
