...
// Package xpsapi implements the general xPayments API functions.
package xpsapi
...
type Backend interface {
	...
	ExtRPCEnabled() bool
	RPCGasCap() uint64            // global gas cap for xps_call over rpc: DoS protection
	RPCXVMTimeout() time.Duration // global timeout for xps_call over rpc: DoS protection
	...
	GetXVM(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header, vmConfig *vm.Config) (*vm.XVM, func() error, error)
