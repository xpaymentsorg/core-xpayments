...
func TestGetSettleBalance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"BUY, quote is not XPS, makerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is not XPS, takerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is XPS, makerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
				baseToken:         testToken,
				quoteToken:        common.HexToAddress(common.XPSNativeAddress),
				makerPrice:        common.BasePrice,
				makerFeeRate:      big.NewInt(10), // feeRate 0.1%
				baseTokenDecimal:  common.BasePrice,
				quoteTokenDecimal: common.BasePrice,
		...
		{
			"BUY, quote is XPS, takerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Taker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.HexToAddress(common.XPSNativeAddress), OutTotal: tradeQuantityIncludedFee},
				Maker: TradeResult{Fee: testFee, InToken: common.HexToAddress(common.XPSNativeAddress), InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
		...
		{
			"SELL, quote is not XPS, makerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is not XPS, takerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
		...
		{
			"SELL, quote is XPS, makerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is XPS, takerFee <= 0.001 XPS",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Maker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.HexToAddress(common.XPSNativeAddress), OutTotal: tradeQuantityIncludedFee},
				Taker: TradeResult{Fee: testFee, InToken: common.HexToAddress(common.XPSNativeAddress), InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
	}
