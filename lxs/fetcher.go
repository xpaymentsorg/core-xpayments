...
import (
	...
	"github.com/xpaymentsorg/go-xpayments/lxs/fetcher"
...
// announce represents an new block announcement from the lxs server.
...
func (f *lightFetcher) mainloop() {
	...
	for {
		...
		case ev := <-headCh:
			...
			// Clean stale announcements from lxs-servers.
