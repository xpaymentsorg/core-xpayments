...
// PrivateLightServerAPI provides an API to access the LXS light server.
type PrivateLightServerAPI struct {
	server                               *LxsServer
	defaultPosFactors, defaultNegFactors vfs.PriceFactors
}

// NewPrivateLightServerAPI creates a new LXS light server API.
func NewPrivateLightServerAPI(server *LxsServer) *PrivateLightServerAPI {
...
// PrivateDebugAPI provides an API to debug LXS light server functionality.
type PrivateDebugAPI struct {
	server *LxsServer
}

// NewPrivateDebugAPI creates a new LXS light server debug API.
func NewPrivateDebugAPI(server *LxsServer) *PrivateDebugAPI {
...
// PrivateLightAPI provides an API to access the LXS light server or light client.
type PrivateLightAPI struct {
	backend *lxsCommons
}

// NewPrivateLightAPI creates a new LXS service API.
func NewPrivateLightAPI(backend *lxsCommons) *PrivateLightAPI {
