...
func TestSequentialAnnouncementsLxs2(t *testing.T) { testSequentialAnnouncements(t, 2) }
func TestSequentialAnnouncementsLxs3(t *testing.T) { testSequentialAnnouncements(t, 3) }
...
func testSequentialAnnouncements(t *testing.T, protocol int) {
	...
	// Create connected peer pair, the initial signal from LXS server
...
func TestGappedAnnouncementsLxs2(t *testing.T) { testGappedAnnouncements(t, 2) }
func TestGappedAnnouncementsLxs3(t *testing.T) { testGappedAnnouncements(t, 3) }
...
func testGappedAnnouncements(t *testing.T, protocol int) {
	...
	blocks, _ := core.GenerateChain(rawdb.ReadChainConfig(s.db, s.backend.Blockchain().Genesis().Hash()), s.backend.Blockchain().GetBlockByNumber(3),
		xpsash.NewFaker(), s.db, 2, func(i int, gen *core.BlockGen) {
...
func TestTrustedAnnouncementsLxs2(t *testing.T) { testTrustedAnnouncement(t, 2) }
func TestTrustedAnnouncementsLxs3(t *testing.T) { testTrustedAnnouncement(t, 3) }
...
func TestInvalidAnnouncesLXS2(t *testing.T) { testInvalidAnnounces(t, lpv2) }
func TestInvalidAnnouncesLXS3(t *testing.T) { testInvalidAnnounces(t, lpv3) }
func TestInvalidAnnouncesLXS4(t *testing.T) { testInvalidAnnounces(t, lpv4) }
