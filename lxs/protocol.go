...
// Supported versions of the lxs protocol (first is primary)
var (
...
// reqMapping maps an LXS request to one or two vflux service vector entries.
...
var (
	// requests describes the available LXS request types and their initializing amounts
