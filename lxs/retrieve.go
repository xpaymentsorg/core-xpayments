...
// deliver is called by the LXS protocol manager to deliver reply messages to waiting requests
...
// frozen is called by the LXS protocol manager when a server has suspended its service and we
