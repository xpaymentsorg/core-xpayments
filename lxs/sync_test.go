...
func TestLightSyncingLxs3(t *testing.T) { testCheckpointSyncing(t, lpv3, 0) }

// Test legacy checkpoint syncing which will download tail headers
// based on a hardcoded checkpoint.
func TestLegacyCheckpointSyncingLxs3(t *testing.T) { testCheckpointSyncing(t, lpv3, 1) }

// Test checkpoint syncing which will download tail headers based
// on a verified checkpoint.
func TestCheckpointSyncingLxs3(t *testing.T) { testCheckpointSyncing(t, lpv3, 2) }
...
func testMissOracleBackend(t *testing.T, hasCheckpoint bool, protocol int) {
	...
	//
	// See https://github.com/xpayments/go-xpayments/issues/20097 for more detail.
	//
