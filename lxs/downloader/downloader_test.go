...
type downloadTester struct {
	...
	stateDb xpsdb.Database // Database used by the tester for syncing from peers
	peerDb  xpsdb.Database // Database of the peers containing all data
...
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, xps.XPS66, FastSync) }
...
func TestThrottling66Fast(t *testing.T) { testThrottling(t, xps.XPS66, FastSync) }
...
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, xps.XPS66, FastSync) }
...
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, xps.XPS66, FastSync) }
...
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, xps.XPS66, FastSync) }
...
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, xps.XPS66, FastSync)
}
...
func TestCancel66Fast(t *testing.T)  { testCancel(t, xps.XPS66, FastSync) }
...
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, xps.XPS66, FastSync) }
...
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, xps.XPS66, FastSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", xps.XPS66, chain)
	//tester.newPeer("peer 65", xps.XPS67, chain)
...
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, xps.XPS66, FastSync) }
...
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, xps.XPS66, FastSync) }
...
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, xps.XPS66, FastSync) }
...
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, xps.XPS66, FastSync) }
...
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, xps.XPS66, FastSync)
}
...
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, xps.XPS66, FastSync) }
...
func checkProgress(t *testing.T, d *Downloader, stage string, want xpayments.SyncProgress) {
	// Mark this mxpsod as a helper to report errors at callsite, not in here
	t.Helper()
...
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, xps.XPS66, FastSync) }
...
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, xps.XPS66, FastSync) }
...
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, xps.XPS66, FastSync) }
...
func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, xps.XPS66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, xps.XPS66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, xps.XPS66, LightSync) }
...
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, xps.XPS66, FastSync) }
