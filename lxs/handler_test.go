...
import (
	...
	"github.com/xpaymentsorg/go-xpayments/lxs/downloader"
...
func TestGetBlockHeadersLxs2(t *testing.T) { testGetBlockHeaders(t, 2) }
func TestGetBlockHeadersLxs3(t *testing.T) { testGetBlockHeaders(t, 3) }
func TestGetBlockHeadersLxs4(t *testing.T) { testGetBlockHeaders(t, 4) }
...
func TestGetBlockBodiesLxs2(t *testing.T) { testGetBlockBodies(t, 2) }
func TestGetBlockBodiesLxs3(t *testing.T) { testGetBlockBodies(t, 3) }
func TestGetBlockBodiesLxs4(t *testing.T) { testGetBlockBodies(t, 4) }
...
func TestGetCodeLxs2(t *testing.T) { testGetCode(t, 2) }
func TestGetCodeLxs3(t *testing.T) { testGetCode(t, 3) }
func TestGetCodeLxs4(t *testing.T) { testGetCode(t, 4) }
...
func TestGetStaleCodeLxs2(t *testing.T) { testGetStaleCode(t, 2) }
func TestGetStaleCodeLxs3(t *testing.T) { testGetStaleCode(t, 3) }
func TestGetStaleCodeLxs4(t *testing.T) { testGetStaleCode(t, 4) }
...
func TestGetReceiptLxs2(t *testing.T) { testGetReceipt(t, 2) }
func TestGetReceiptLxs3(t *testing.T) { testGetReceipt(t, 3) }
func TestGetReceiptLxs4(t *testing.T) { testGetReceipt(t, 4) }
...
func TestGetProofsLxs2(t *testing.T) { testGetProofs(t, 2) }
func TestGetProofsLxs3(t *testing.T) { testGetProofs(t, 3) }
func TestGetProofsLxs4(t *testing.T) { testGetProofs(t, 4) }
...
// Tests that the stale contract codes can't be retrieved based on account addresses.
func TestGetStaleProofLxs2(t *testing.T) { testGetStaleProof(t, 2) }
func TestGetStaleProofLxs3(t *testing.T) { testGetStaleProof(t, 3) }
func TestGetStaleProofLxs4(t *testing.T) { testGetStaleProof(t, 4) }
...
func TestGetCHTProofsLxs2(t *testing.T) { testGetCHTProofs(t, 2) }
func TestGetCHTProofsLxs3(t *testing.T) { testGetCHTProofs(t, 3) }
func TestGetCHTProofsLxs4(t *testing.T) { testGetCHTProofs(t, 4) }
...
func TestGetBloombitsProofsLxs2(t *testing.T) { testGetBloombitsProofs(t, 2) }
func TestGetBloombitsProofsLxs3(t *testing.T) { testGetBloombitsProofs(t, 3) }
func TestGetBloombitsProofsLxs4(t *testing.T) { testGetBloombitsProofs(t, 4) }
...
func TestTransactionStatusLxs2(t *testing.T) { testTransactionStatus(t, lpv2) }
func TestTransactionStatusLxs3(t *testing.T) { testTransactionStatus(t, lpv3) }
func TestTransactionStatusLxs4(t *testing.T) { testTransactionStatus(t, lpv4) }
...
func testTransactionStatus(t *testing.T, protocol int) {
	...
	gchain, _ := core.GenerateChain(params.TestChainConfig, chain.GetBlockByNumber(0), xpsash.NewFaker(), server.db, 1, func(i int, block *core.BlockGen) {
		block.AddTx(tx1)
		block.AddTx(tx2)
	})
	...
	gchain, _ = core.GenerateChain(params.TestChainConfig, chain.GetBlockByNumber(0), xpsash.NewFaker(), server.db, 2, func(i int, block *core.BlockGen) {})
	if _, err := chain.InsertChain(gchain); err != nil {
		panic(err)
	}
...
func TestStopResumeLXS3(t *testing.T) { testStopResume(t, lpv3) }
func TestStopResumeLXS4(t *testing.T) { testStopResume(t, lpv4) }
