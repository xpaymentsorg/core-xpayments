...
func getChain() *core.BlockChain {
	...
	blocks, _ := core.GenerateChain(gspec.Config, genesis, xpsash.NewFaker(), db, 2,
	...
	bc, _ := core.NewBlockChain(db, cacheConf, gspec.Config, xpsash.NewFaker(), vm.Config{}, nil, nil)
