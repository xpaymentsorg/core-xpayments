...
func TestNotUpdateSignerListIfNotOnGapBlock(t *testing.T) {
	blockchain, backend, parentBlock := PrepareXPSTestBlockChain(t, 400, params.TestXPoSMockChainConfig)
...
func TestNotChangeSingerListIfNothingProposedOrVoted(t *testing.T) {
	blockchain, _, parentBlock := PrepareXPSTestBlockChain(t, GAP-1, params.TestXPoSMockChainConfig)
	// Insert block 450
...
func TestUpdateSignerListIfVotedBeforeGap(t *testing.T) {
	...
	blockchain, backend, parentBlock := PrepareXPSTestBlockChain(t, GAP-2, params.TestXPoSMockChainConfig)
...
func TestCallUpdateM1WithSmartContractTranscation(t *testing.T) {
	...
	blockchain, backend, currentBlock := PrepareXPSTestBlockChain(t, GAP-1, params.TestXPoSMockChainConfig)
...
func TestStatesShouldBeUpdatedWhenForkedBlockBecameMainChainAtGapBlock(t *testing.T) {
	...
	blockchain, backend, parentBlock := PrepareXPSTestBlockChain(t, GAP-1, params.TestXPoSMockChainConfig)
