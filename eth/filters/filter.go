...
type Backend interface {
	...
	GetXPoSBlockReceipt(ctx context.Context, blockHash common.Hash) (*types.Receipt, error)
	GetXPoSBlockLogs(ctx context.Context, blockHash common.Hash) ([]*types.Log, error)
