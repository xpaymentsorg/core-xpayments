...
//
// xps_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// xps_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.XpsSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "xps_getBlockByNumber", "latest", false)
	if err != nil {
