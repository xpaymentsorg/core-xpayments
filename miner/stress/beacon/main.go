...
import (
	...
	lescatalyst "github.com/xpaymentsorg/go-xpayments/lxs/catalyst"
...
func makeLightNode(genesis *core.Genesis) (*node.Node, *lxs.LightxPayments, *lescatalyst.ConsensusAPI, error) {
	// Define the basic configurations for the xPayments node
	datadir, _ := ioutil.TempDir("", "")
	...
	lesBackend, err := lxs.New(stack, &xpsconfig.Config{
		Genesis:         genesis,
		NetworkId:       genesis.Config.ChainID.Uint64(),
