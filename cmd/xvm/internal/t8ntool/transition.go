...
func Transition(ctx *cli.Context) error {
	...
	var getTracer func(txIndex int, txHash common.Hash) (vm.XVMLogger, error)
	...
	if ctx.Bool(TraceFlag.Name) {
		...
		getTracer = func(txIndex int, txHash common.Hash) (vm.XVMLogger, error) {
			if prevFile != nil {
				prevFile.Close()
			}
		...
		getTracer = func(txIndex int, txHash common.Hash) (tracer vm.XVMLogger, err error) {
			return nil, nil
		}
	}
