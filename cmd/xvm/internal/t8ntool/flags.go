...
var (
	...
	SealXpsashFlag = cli.BoolFlag{
		Name:  "seal.xpsash",
		Usage: "Seal block with xpsash.",
	}
	SealXpsashDirFlag = cli.StringFlag{
		Name:  "seal.xpsash.dir",
		Usage: "Path to xpsash DAG. If none exists, a new DAG will be generated.",
	}
	SealXpsashModeFlag = cli.StringFlag{
		Name:  "seal.xpsash.mode",
		Usage: "Defines the type and amount of PoW verification an xpsash engine makes.",
		Value: "normal",
	}
