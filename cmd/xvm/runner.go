...
import (
	...
	"github.com/xpaymentsorg/go-xpayments/cmd/xvm/internal/compiler"
...
var runCommand = cli.Command{
	Action:      runCmd,
	Name:        "run",
	Usage:       "run arbitrary xvm binary",
	ArgsUsage:   "<code>",
	Description: `The run command runs arbitrary XVM code.`,
}
...
func runCmd(ctx *cli.Context) error {
	...
	if bench || ctx.GlobalBool(StatDumpFlag.Name) {
		fmt.Fprintf(os.Stderr, `XVM gas used:    %d
execution time:  %v
allocations:     %d
allocated bytes: %d
