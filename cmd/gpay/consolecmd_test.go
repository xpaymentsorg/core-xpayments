...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 xps:1.0 xpsash:1.0 miner:1.0 net:1.0 personal:1.0 rpc:1.0 txpool:1.0 web3:1.0"
	httpAPIs = "xps:1.0 net:1.0 rpc:1.0 web3:1.0"
)
...
func TestConsoleWelcome(t *testing.T) {
	...
	gpay := runMinimalGpay(t, "--miner.xpserbase", coinbase, "console")
...
func TestAttachWelcome(t *testing.T) {
	...
	gpay := runMinimalGpay(t, "--miner.xpserbase", "0x8605cdbbdb6d264aa742e77020dcbc58fcdce182",
		"--ipcpath", ipc,
...
func testAttachWelcome(t *testing.T, gpay *testgpay, endpoint, apis string) {
	...
	attach.SetTemplateFunc("xpserbase", func() string { return gpay.Xpserbase })
