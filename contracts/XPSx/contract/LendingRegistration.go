...
// LAbstractXPSXListingABI is the input ABI used to generate the binding from.
const LAbstractXPSXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractXPSXListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractXPSXListingBin = `0x`

// DeployLAbstractXPSXListing deploys a new Ethereum contract, binding an instance of LAbstractXPSXListing to it.
func DeployLAbstractXPSXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractXPSXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractXPSXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractXPSXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractXPSXListing{LAbstractXPSXListingCaller: LAbstractXPSXListingCaller{contract: contract}, LAbstractXPSXListingTransactor: LAbstractXPSXListingTransactor{contract: contract}, LAbstractXPSXListingFilterer: LAbstractXPSXListingFilterer{contract: contract}}, nil
}

// LAbstractXPSXListing is an auto generated Go binding around an Ethereum contract.
type LAbstractXPSXListing struct {
	LAbstractXPSXListingCaller     // Read-only binding to the contract
	LAbstractXPSXListingTransactor // Write-only binding to the contract
	LAbstractXPSXListingFilterer   // Log filterer for contract events
}

// LAbstractXPSXListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractXPSXListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractXPSXListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractXPSXListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractXPSXListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractXPSXListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractXPSXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractXPSXListingSession struct {
	Contract     *LAbstractXPSXListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts         // Call options to use throughout this session
	TransactOpts bind.TransactOpts     // Transaction auth options to use throughout this session
}

// LAbstractXPSXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractXPSXListingCallerSession struct {
	Contract *LAbstractXPSXListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts               // Call options to use throughout this session
}

// LAbstractXPSXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractXPSXListingTransactorSession struct {
	Contract     *LAbstractXPSXListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts               // Transaction auth options to use throughout this session
}

// LAbstractXPSXListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractXPSXListingRaw struct {
	Contract *LAbstractXPSXListing // Generic contract binding to access the raw methods on
}

// LAbstractXPSXListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractXPSXListingCallerRaw struct {
	Contract *LAbstractXPSXListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractXPSXListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractXPSXListingTransactorRaw struct {
	Contract *LAbstractXPSXListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractXPSXListing creates a new instance of LAbstractXPSXListing, bound to a specific deployed contract.
func NewLAbstractXPSXListing(address common.Address, backend bind.ContractBackend) (*LAbstractXPSXListing, error) {
	contract, err := bindLAbstractXPSXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractXPSXListing{LAbstractXPSXListingCaller: LAbstractXPSXListingCaller{contract: contract}, LAbstractXPSXListingTransactor: LAbstractXPSXListingTransactor{contract: contract}, LAbstractXPSXListingFilterer: LAbstractXPSXListingFilterer{contract: contract}}, nil
}

// NewLAbstractXPSXListingCaller creates a new read-only instance of LAbstractXPSXListing, bound to a specific deployed contract.
func NewLAbstractXPSXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractXPSXListingCaller, error) {
	contract, err := bindLAbstractXPSXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractXPSXListingCaller{contract: contract}, nil
}

// NewLAbstractXPSXListingTransactor creates a new write-only instance of LAbstractXPSXListing, bound to a specific deployed contract.
func NewLAbstractXPSXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractXPSXListingTransactor, error) {
	contract, err := bindLAbstractXPSXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractXPSXListingTransactor{contract: contract}, nil
}

// NewLAbstractXPSXListingFilterer creates a new log filterer instance of LAbstractXPSXListing, bound to a specific deployed contract.
func NewLAbstractXPSXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractXPSXListingFilterer, error) {
	contract, err := bindLAbstractXPSXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractXPSXListingFilterer{contract: contract}, nil
}

// bindLAbstractXPSXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractXPSXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractXPSXListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractXPSXListing *LAbstractXPSXListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractXPSXListing.Contract.LAbstractXPSXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractXPSXListing *LAbstractXPSXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractXPSXListing.Contract.LAbstractXPSXListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractXPSXListing *LAbstractXPSXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractXPSXListing.Contract.LAbstractXPSXListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractXPSXListing *LAbstractXPSXListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractXPSXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractXPSXListing *LAbstractXPSXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractXPSXListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractXPSXListing *LAbstractXPSXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractXPSXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractXPSXListing *LAbstractXPSXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _LAbstractXPSXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractXPSXListing *LAbstractXPSXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractXPSXListing.Contract.GetTokenStatus(&_LAbstractXPSXListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractXPSXListing *LAbstractXPSXListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractXPSXListing.Contract.GetTokenStatus(&_LAbstractXPSXListing.CallOpts, arg0)
}

// LendingABI is the input ABI used to generate the binding from.
const LendingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"COLLATERALS\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"ORACLE_PRICE_FEEDER\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"term\",\"type\":\"uint256\"}],\"name\":\"addTerm\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"LENDINGRELAYER_LIST\",\"outputs\":[{\"name\":\"_tradeFee\",\"type\":\"uint16\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"Relayer\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"coinbase\",\"type\":\"address\"},{\"name\":\"tradeFee\",\"type\":\"uint16\"},{\"name\":\"baseTokens\",\"type\":\"address[]\"},{\"name\":\"terms\",\"type\":\"uint256[]\"},{\"name\":\"collaterals\",\"type\":\"address[]\"}],\"name\":\"update\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"XPSXListing\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"MODERATOR\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"token\",\"type\":\"address\"},{\"name\":\"depositRate\",\"type\":\"uint256\"},{\"name\":\"liquidationRate\",\"type\":\"uint256\"},{\"name\":\"recallRate\",\"type\":\"uint256\"}],\"name\":\"addILOCollateral\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"coinbase\",\"type\":\"address\"},{\"name\":\"tradeFee\",\"type\":\"uint16\"}],\"name\":\"updateFee\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"moderator\",\"type\":\"address\"}],\"name\":\"changeModerator\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"TERMS\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"BASES\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"COLLATERAL_LIST\",\"outputs\":[{\"name\":\"_depositRate\",\"type\":\"uint256\"},{\"name\":\"_liquidationRate\",\"type\":\"uint256\"},{\"name\":\"_recallRate\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"token\",\"type\":\"address\"}],\"name\":\"addBaseToken\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"token\",\"type\":\"address\"},{\"name\":\"lendingToken\",\"type\":\"address\"},{\"name\":\"price\",\"type\":\"uint256\"}],\"name\":\"setCollateralPrice\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"ILO_COLLATERALS\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"feeder\",\"type\":\"address\"}],\"name\":\"changeOraclePriceFeeder\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"token\",\"type\":\"address\"},{\"name\":\"depositRate\",\"type\":\"uint256\"},{\"name\":\"liquidationRate\",\"type\":\"uint256\"},{\"name\":\"recallRate\",\"type\":\"uint256\"}],\"name\":\"addCollateral\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"token\",\"type\":\"address\"},{\"name\":\"lendingToken\",\"type\":\"address\"}],\"name\":\"getCollateralPrice\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"},{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"coinbase\",\"type\":\"address\"}],\"name\":\"getLendingRelayerByCoinbase\",\"outputs\":[{\"name\":\"\",\"type\":\"uint16\"},{\"name\":\"\",\"type\":\"address[]\"},{\"name\":\"\",\"type\":\"uint256[]\"},{\"name\":\"\",\"type\":\"address[]\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"r\",\"type\":\"address\"},{\"name\":\"t\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"

// LendingBin is the compiled bytecode used for deploying new contracts.
const LendingBin = ``
...
// XPSXListing is a free data retrieval call binding the contract method 0x317c646f.
//
// Solidity: function XPSXListing() constant returns(address)
func (_Lending *LendingCaller) XPSXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "XPSXListing")
	return *ret0, err
}
...
//
// Solidity: function XPSXListing() constant returns(address)
func (_Lending *LendingSession) XPSXListing() (common.Address, error) {
	return _Lending.Contract.XPSXListing(&_Lending.CallOpts)
}

// XPSXListing is a free data retrieval call binding the contract method 0x317c646f.
//
// Solidity: function XPSXListing() constant returns(address)
func (_Lending *LendingCallerSession) XPSXListing() (common.Address, error) {
	return _Lending.Contract.XPSXListing(&_Lending.CallOpts)
}
